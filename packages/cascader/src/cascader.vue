...
<script>
import Popper from 'effortless-ui/src/utils/vue-popper';
import Clickoutside from 'effortless-ui/src/utils/clickoutside';
import Emitter from 'effortless-ui/src/mixins/emitter';
import Locale from 'effortless-ui/src/mixins/locale';
import Migrating from 'effortless-ui/src/mixins/migrating';
import ElInput from 'effortless-ui/packages/input';
import ElTag from 'effortless-ui/packages/tag';
import ElScrollbar from 'effortless-ui/packages/scrollbar';
import ElCascaderPanel from 'effortless-ui/packages/cascader-panel';
import AriaUtils from 'effortless-ui/src/utils/aria-utils';
import { t } from 'effortless-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'effortless-ui/src/utils/util';
import { isUndefined, isFunction } from 'effortless-ui/src/utils/types';
import { isDef } from 'effortless-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'effortless-ui/src/utils/resize-event';
