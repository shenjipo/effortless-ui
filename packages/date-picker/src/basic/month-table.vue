...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'effortless-ui/src/utils/date-util';
  import { hasClass } from 'effortless-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'effortless-ui/src/utils/util';
